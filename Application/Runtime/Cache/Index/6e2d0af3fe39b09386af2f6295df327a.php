...
<div class="container">
    ...
    <div class="content">
        <h3>简介</h3>
        <p>本站基于Github开源项目二次开发。使用PHP配合MYSQL开发完成，数据传输使用RSA等加密方式加密保证数据无法被截取，系统主要有软件管理、注册码生成、注册码管理等功能，为软件作者的软件收费管理提供一个绝佳的选择方案。</p>
        <h3>后台系统介绍</h3>
        <p>* 以下功能不包括最新功能</p>
        ...
        <h3>关于防破解</h3>
        <p>插件本身是具有防破解能力的。但是软件的防破解和插件是分开独立的，您的软件集成我们的插件后请一定要进行暗桩加壳等尽可能多的方式增加破解难度。</p>
    </div>
    <div class="bottom">
    Copyright © 2019 粤ICP备19040606号-1  土味免费网络验证
</div>
