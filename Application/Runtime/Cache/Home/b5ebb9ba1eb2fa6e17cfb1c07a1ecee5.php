...
<div class="left-container">
    <ul class="nav sidenav" style="margin-top:-15px">
        ...
        <li>
            ...
            <ul class="nav">
                <li>
                    <a href="https://pan.baidu.com/s/1cB4hZhPcHlgsS2XjXrnB6A" id="down">下载</a>
                </li>
                <li>
                    <a class="<?php echo ($contact_selected); ?>" href="/Home/contact">联系我们</a>
                </li>
                <li>
                    <a class="<?php echo ($support_selected); ?>" href="/Home/support">捐助我们</a>
                </li>
            </ul>
        </li>
    </ul>
...
<script>
    $("#down").click(function(){
        alert("密码是：5kuq");
        window.location="https://pan.baidu.com/s/1cB4hZhPcHlgsS2XjXrnB6A";
    })
</script>

<div class="right-container">
    <img class="qrcode" src="/Public/image/qrcode.png" alt="支付宝二维码">
    <span class="description">这是本人的微信二维码，网站运营需要服务器费用，如果能给予本网站一点捐助，在下一定万分感谢！不管多少，您的帮助就是本网站免费运营下去的动力！</span>
</div>
